...
import { eventGetAdmin, getAdminEventList } from "../../ducks/events";
import { EventsDataUtil } from "../../dataUtils";
import { useSelector } from "react-redux";

const AdminEvents = ({ hideCalendar, horizontalCalendar, getSearch }: any) => {
  const getCustomEventListData = useSelector(getAdminEventList);
    ...
    <Block style={styles.subContainerStyle}>
      ...
      <FlatListApi
        payload={{
          ...
          event_type: EVENT_TYPES.ADMIN,
          date: filterDate,
        }}
        actionType={eventGetAdmin.type}
        showsVerticalScrollIndicator={false}
        selectorData={getAdminEventList}
        requestAction={eventGetAdmin.request}
        // ListHeaderComponent={() =>
        //   hideCalendar
        //     ? undefined
        //     : getCustomEventListData.length > 0
...
export default React.memo(AdminEvents);
